...
This documentation provides a comprehensive guide for integrating Mular's Wallet Funding service into your mobile application. This service enables businesses to offer crypto wallet funding to their users, instantly converting crypto deposits into Naira in the user's wallet. Right within your mobile app.

## Overview

This Mular Wallet Funding API allows you to:
1.  **Create Sub Accounts**: Register your users on Mular.
2.  **Generate Wallet Addresses**: Assign dedicated crypto deposit addresses to your users.
...
Register a user from your platform as a sub-account on Mular. This is required to generate wallet addresses for them.
